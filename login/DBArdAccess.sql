...
CREATE TABLE `registros` (
  `IDRegistros` bigint(20) UNSIGNED NOT NULL,
  `HORA_USO` datetime NOT NULL DEFAULT current_timestamp(),
...
ALTER TABLE `huellas`
  ...
  ADD UNIQUE KEY `IDHUELLA` (`IDHUELLA`),
...
ALTER TABLE `registros`
  ...
  ADD UNIQUE KEY `IDRegistros` (`IDRegistros`),
  ADD KEY `FK_Registros_users` (`IDUSER`);
...
--
ALTER TABLE `registros`
  MODIFY `IDRegistros` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `huellas`
  ADD CONSTRAINT `FK_users_Huellas` FOREIGN KEY (`IDUSER`) REFERENCES `users` (`IDUSER`);
--
...
('login', 'huellas', 'IDHUELLA'),
('login', 'registros', 'ACCESO'),
('login', 'users', 'IDUSER');
